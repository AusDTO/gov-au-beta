...
RSpec.describe Revision, type: :model do
  ...
  describe 'scopes' do
    let(:node) { Fabricate(:general_content, parent: section_home, content_body: nil, name: nil, short_summary: nil, summary: nil) }
  ...
  describe '#apply!' do
    let(:node) { Fabricate(:general_content, parent: section_home, content_body: 'initial content') }
  ...
  describe 'patching' do
    let(:node) { Fabricate(:general_content, parent: section_home, content_body: nil) }
    let(:basic_content) { "a\n\nb\n\nc" }
