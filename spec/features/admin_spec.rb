  ...
  context 'an admin user' do
    ...
    context 'home page sidebar links' do
      ...
      it 'should show links to administer content types' do
        expect(sidebar.find_link('General Contents')[:href]).to eq '/admin/general_contents'
        expect(sidebar.find_link('News Articles')[:href]).to eq '/admin/news_articles'
      end

      it 'should show links to administer users' do
      expect(sidebar.find_link('Users')[:href]).to eq '/admin/users'
      end
